...
def verifica(elemento,rec):
  return(any(elemento in ingrediente for ingrediente in rec['Ingredientes']))
...
def funciónFiltroRecetas(alergias=None, ingredientes=None ): #sería una lista de alergias y lista de ingredientes ya definidos
  ...
  if ingredientes == None and alergias != None : #Hay alguna alergia
  ...
  if ingredientes != None and alergias == None: #Hay algun ingrediente
  ...
  if ingredientes != None and alergias != None : #Ingrediente y alergia
